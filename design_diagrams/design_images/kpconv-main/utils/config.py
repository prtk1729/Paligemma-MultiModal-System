...
class Config:
    ...
    # Set the smoothing parameter for testing
    # 0 for no smoothing, values close to 1 for significant smoothing
    test_smooth = 0.95
    test_radius_ratio = 0.7  # Radius ratio for test smoothing
